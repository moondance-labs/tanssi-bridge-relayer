...
func ConvertToSimplifiedMMRProof(blockhash types.H256, leafIndex uint64, leaf MMRLeafSolochain, leafCount uint64, proofItems []types.H256) (SimplifiedMMRProof, error) {
