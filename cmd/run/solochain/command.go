...
import (
	...
	"github.com/moondance-labs/tanssi-bridge-relayer/relays/solochain"
...
func run(_ *cobra.Command, _ []string) error {
	...
	relay, err := solochain.NewRelay(&config, keypair)
	if err != nil {
		return err
	}
...
func HexHookFunc() mapstructure.DecodeHookFuncType {
	return func(
		...
		if t != reflect.TypeOf(solochain.ChannelID{}) {
			return data, nil
		}
		...
		return solochain.ChannelID(out), nil
	}
}
