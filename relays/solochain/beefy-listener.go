...
import (
	...
	relayCommon "github.com/moondance-labs/tanssi-bridge-relayer/relays/common"
...
func (li *BeefyListener) generateProof(ctx context.Context, input *ProofInput) (*ProofOutput, error) {
	...
	mmrProof, err := relayCommon.GenerateProofForBlock(
		li.relaychainConn.API().Client,
	...
	simplifiedProof, err := relayCommon.ConvertToSimplifiedMMRProof(
		mmrProof.BlockHash,
